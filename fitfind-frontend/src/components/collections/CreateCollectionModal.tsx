...
interface CreateCollectionModalProps {
  ...
  onCreateCollection: (name: string, description?: string, isPrivate?: boolean) => Promise<{ success: boolean; error?: string }>;
}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.error || 'Failed to create collection. Please try again.');
      }
    } catch (err) {
